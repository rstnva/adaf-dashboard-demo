...
const guides: Array<{ prefix: string; guide: Guide }> = [
  {
    ...
    guide: {
      ...
      success: "Identificaste la causa y accionaste (escalado/reintento/runbook).",
  ...
  },
  {
    ...
    guide: {
      ...
      success: "Puedes explicar el estado y abrir el panel correcto para profundizar.",
  ...
  },
  {
    ...
    guide: {
      ...
      objective: "Detectar cambios de régimen por flujos y su efecto en precio.",
      steps: [
  ...
  },
  {
    ...
    guide: {
      ...
      success: "Identificaste zonas probables de atracción/repulsión de precio.",
      cta: { label: "Aprende más (Derivados)", href: "/academy?topic=derivatives" },
    },
  },
  {
    prefix: "/markets",
  ...
  },
  {
    ...
    guide: {
      ...
      cta: { label: "Aprende más (Seguridad)", href: "/academy?topic=security" },
    },
  },
  {
    prefix: "/reports",
...
export function PageGuide({ className }: { className?: string }) {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener("pageguide:always-changed", handler as EventListener);
    return () => window.removeEventListener("pageguide:always-changed", handler as EventListener);
  }, [open]);
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        {!always ? (
          ...
          <span className="text-xs text-amber-700">Mostrando siempre (preferencia global)</span>
        )}
      </div>
      {open && (
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <p className="text-sm">
              <span className="font-semibold">Objetivo:</span> {guide.objective}
            </p>
            <div>
