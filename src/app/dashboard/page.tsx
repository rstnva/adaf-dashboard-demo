          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-1">
                <Link href="/dashboard" className="px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium">
                  Dashboard
                </Link>
      ...
      <main className="container mx-auto px-6 py-6 space-y-8">
        ...
        <div className="text-center text-sm text-muted-foreground py-6 border-t">
          <div className="flex items-center justify-center gap-6 flex-wrap">
            ...
            <span className="flex items-center gap-2">
              📊 Última actualización: {navTs ? new Date(navTs).toLocaleTimeString() : 'Cargando...'}
            </span>
            <span className="flex items-center gap-2">
              💾 DB: Conectada
            </span>
